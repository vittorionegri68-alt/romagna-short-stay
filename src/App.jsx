    ...
    <section style={{ background: C.bg, padding: "9rem 2rem 6rem",
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <p style={{ opacity: loaded ? 1 : 0,
          ...
          Curated apartments, B&Bs and holiday homes between Cesena, Rimini,
          the Romagna hills and the Adriatic Riviera. Book directly on Airbnb.
        </p>
        ...
        <div style={{ padding: "1.4rem 1.5rem", flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ marginBottom: "1.25rem" }}>
            <div style={{ fontSize: "0.6rem", letterSpacing: "0.18em", color: C.textSoft,
              textTransform: "uppercase", fontFamily: "'DM Sans',sans-serif",
              marginBottom: "0.5rem" }}>Key distances</div>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        <Reveal>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond','Playfair Display',serif",
            ...
            From the<br />
            <span style={{ color: C.gold, fontStyle: "italic" }}>Romagna Short Stay blog</span>
          </h2>
        </Reveal>
              ...
              <Reveal key={p.id} delay={i * 80} stretch>
                <div onClick={() => setSelected(p)}
                  ...
                  <span style={{ fontSize: "0.72rem", color: C.gold, fontWeight: 700,
                    ...
                    textTransform: "uppercase" }}>Read more →</span>
                </div>
              </Reveal>
            ))}
          </div>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        <Reveal>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond','Playfair Display',serif",
            ...
            <span style={{ color: C.gold, fontStyle: "italic" }}>about short rentals in Romagna</span>
          </h2>
        </Reveal>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
        <Reveal>
          <div style={{ fontSize: "0.65rem", letterSpacing: "0.28em", color: C.gold,
            textTransform: "uppercase", fontFamily: "'DM Sans',sans-serif",
            marginBottom: "1rem" }}>Are you a host?</div>
          <h2 style={{ fontFamily: "'Cormorant Garamond','Playfair Display',serif",
            fontSize: "clamp(1.8rem,4vw,3rem)", color: C.text, fontWeight: 700,
            lineHeight: 1.1, marginBottom: "1rem", letterSpacing: "-0.02em" }}>
            List your property<br />
            <span style={{ color: C.gold, fontStyle: "italic" }}>on our directory.</span>
          </h2>
          <p style={{ fontSize: "0.92rem", color: C.textMid, lineHeight: 1.8,
            fontFamily: "'DM Sans',sans-serif", marginBottom: "2rem" }}>
            Do you have an apartment, B&B or farmhouse in Romagna? Contact us to be included
            in our curated directory — visible to AI search engines too.
          </p>
          <a href="mailto:luceacollection@gmail.com"
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between",
          ...
          <div>
            <div style={{ fontFamily: "'Cormorant Garamond','Playfair Display',serif",
              ...
              letterSpacing: "0.08em", marginBottom: "0.3rem" }}>ROMAGNA SHORT STAY</div>
            <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.72rem",
              color: "rgba(255,255,255,0.4)", letterSpacing: "0.1em" }}>
              Property directory · Romagna · Italy
            </div>
          </div>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)",
          ...
          <address style={{ fontStyle: "normal", fontFamily: "'DM Sans',sans-serif",
            ...
            <span itemProp="name">Romagna Short Stay</span> ·{" "}
            <span itemProp="address">Corso Garibaldi, Cesena FC, Italy</span> ·{" "}
          ...
          <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.7rem",
            ...
            © {new Date().getFullYear()} Romagna Short Stay · All rights reserved
          </div>
        </div>
      </div>
    </footer>
...
export default function App() {
  ...
  return (
    <>
      ...
      {/* Properties grid */}
      <section id="properties" style={{ background: C.bg, padding: "5rem 2rem 7rem" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          {visibili.length === 0 ? (
            <div style={{ textAlign: "center", padding: "5rem 2rem", color: C.textSoft }}>
              ...
              <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "1.4rem",
                color: C.textMid, marginBottom: "0.5rem" }}>No properties found</div>
